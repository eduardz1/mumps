...
if(MUMPS_UPSTREAM_VERSION VERSION_GREATER_EQUAL 5.5)
  if(MUMPS_intsize64)
...
if(MUMPS_UPSTREAM_VERSION VERSION_LESS 5.8)
...
if(MUMPS_UPSTREAM_VERSION VERSION_LESS 5.6)
  list(APPEND COMM_OTHER_C ${_s}mumps_size.c)
endif()
if(MUMPS_UPSTREAM_VERSION VERSION_LESS 5.2)
...
if(MUMPS_UPSTREAM_VERSION VERSION_GREATER_EQUAL 5.4)
  list(APPEND COMM_OTHER_C ${_s}mumps_register_thread.c)
endif()
if(MUMPS_UPSTREAM_VERSION VERSION_LESS 5.7)
  list(APPEND COMM_OTHER_Fortran ${_s}mumps_type_size.F)
endif()
if(MUMPS_UPSTREAM_VERSION VERSION_GREATER_EQUAL 5.8)
...
foreach(t IN ITEMS mumps_common mumps_common_C mumps_common_Fortran)
  ...
  "$<BUILD_INTERFACE:${MUMPS_upstream_SOURCE_DIR}/src;${MUMPS_upstream_SOURCE_DIR}/include;${NUMERIC_INC}>"
...
foreach(t IN ITEMS ${a}mumps ${a}mumps_C ${a}mumps_Fortran)
  ...
  target_include_directories(${t} PUBLIC
  "$<BUILD_INTERFACE:${MUMPS_upstream_SOURCE_DIR}/include;${NUMERIC_INC}>"
  $<INSTALL_INTERFACE:${CMAKE_INSTALL_INCLUDEDIR}>
  )
